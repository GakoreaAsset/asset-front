...
const LeftMenu = () => {
  ...
  return (
    <>
      ...
      <div id="sidebar-multi-level-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
              <ul className="space-y-2 font-medium">
                  <li>
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">식수관리</span>
                  ...
                  <li>
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">자산관리</span>
                      </a>
                  </li>
                  <li>
                  ...
                  <li>
                      ...
                      <span className="flex-1 ms-3 whitespace-nowrap">마이페이지</span>
                      </a>
                  </li>
              </ul>
          </div>
